...
| CA ATV Report Analysis | This project analyzed autonomous vehicle (ATV) accident reports generated by<br />the California DMV from the year 2016 to 2022.     | https://github.com/peterjiatong/accident-analysis |
| driving-rules          | Contributed to the AIEA Lab’s driving-rules project, extending the functionality to process the<br />DMV Driving Rulebook in Chinese | https://github.com/lgilpin/driving-rules          |
