...
## Selected Coursework & In-Class Projects:

| Project         | Description                                                                               | Repo Link                                                            | Timeline             |                      KeyWord                      |
| --------------- | ----------------------------------------------------------------------------------------- | -------------------------------------------------------------------- | -------------------- | :-----------------------------------------------: |
| Course Work     | EE559 (Machine Learning 1: Supervised Methods) @ USC                                     | https://github.com/peterjiatong/EE559                                | Spring Semester 2025 |            Supervised Machine Learning            |
| Midnight Mayhem | 3D racing game with limited FOV, CSCI526(Advanced Mobile Devices and Game Consoles) @ USC | https://csci-526.github.io/main-crashtest-devs/gold-3/               | Fall Semester 2025   |              C#, Unity, Game Design              |
| Course Work     | EE477L (MOS-VLSI Circuit Design) @ USC                                                    | https://github.com/peterjiatong/EE477L                               | Fall Semester 2024   |           VLSI Circuit Design, AutoCAD           |
| Course Work     | CSE160 (Intro to Computer Graphics) @ UC Santa Cruz                                      | https://github.com/peterjiatong/CSE160                               | Fall Quarter 2024    | Computer graphics, OpenGL, WebGL, event handling |
| Pacman Project  | CSE140 (Artificial Intelligence) @ UC Santa Cruz                                          | https://github.com/peterjiatong/myPacman                             | Spring Quarter 2023  |  AI, Search algorithms, Reinforcement Learning  |
| Course Work     | CSE114A(Foundations of Programming Languages) @ UC Santa Cruz                             | https://github.com/peterjiatong/Foundations-of-Programming-Languages | Spring Quarter 2023  |          Haskell, Functional programming          |
| Mini Ball Game  | Extra credit project for AP Computer Science @ Mission San Jose High School               | https://github.com/peterjiatong/mini-ball-game                       | Fall Semester 2019   |                     C#, Unity                     |
