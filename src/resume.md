...
* Developed a standards validation application in Python to automatically cross-check report content against a local SQL database,
  reducing proofreading time from 20 minutes to 10 seconds for 50-page reports
* Utilized **python-docx** to parse Word documents, and built a web crawler using **requests** and **regex** to fetch and auto-update
  standards from the official government site (csres.com)
* Designed a **PySide6-based GUI** for extracting tables from Word documents into **Excel** or **sql** database, enabled users to select
  specific columns for export and save configuration templates for reuse with similar report formats
